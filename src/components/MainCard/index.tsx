...
const MainCard = ({
  ...
  facilitiesImage?: string | undefined;
  facilitiesImageAlt?: string;
  imageType?: string;
  titleText: string;
  ...
  return (
    <section className={Style.card}>
      ...
      <div className={Style.card__text}>
        ...
        <Paragraph textColor="blue">{paragraphText}</Paragraph>
      </div>
    </section>
  );
};

function insertFacilitiesImage(
  imageType: string | undefined,
  facilitiesImage: string,
  facilitiesImageAlt: string | undefined,
) {
  return (
    <img
      className={
